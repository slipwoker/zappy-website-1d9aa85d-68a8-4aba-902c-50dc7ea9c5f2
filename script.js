    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "ערן פרידלנדר משרד עורכי דין משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '1d9aa85d-68a8-4aba-902c-50dc7ea9c5f2',
                    name: data.name || '',
                    email: data.email || '',
